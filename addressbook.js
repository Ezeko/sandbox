...
function createContact() {
    ...
    //Get all the contact detail's values as well as phone number and store them in the blow variables
    var contactName = document.getElementById("Name").value;
    var eMail = document.getElementById("email").value;
    var phoneNumber = document.getElementById("phoneNumber").value;

    //Create a new li bearing contact name in a nameListItemParagraph
    //paragraph element under the ul and give it the value of the Name
    ...
    //Set the attribute of new nameListItemParagraph, bearing contact name t0 the value of contact name and then the id of nameListItem to contactName
    ...
    //Create a li for the email and give it the value of eMail and  add it to the detailsUnorderedList
    ...
    //Create a li for the phone number and give it the value of phoneNumber and add it to the detailsUnorderedList
    ...
    //Add newly created detailsUnorderedList and its content to the contactNameListItem and give it an attribute of hidden
